...
//            setResult(EagleEyeActivity.RESULT_CODE, intent);
//        }
        super.finish();
    }
    ...
    private void initData() {
        ezOpenSDK = (EZOpenSDK) getIntent().getSerializableExtra("EZOpenSDK");
        // 获取本地信息
...
//        mRealPlaySv.setVisibility(View.VISIBLE);
    ...
    public void onClick(View view) {
        if (view.getId() == R.id.realplay_play_btn ||
                view.getId() == R.id.realplay_full_play_btn ||
                view.getId() == R.id.realplay_play_iv) {
            if (mStatus != RealPlayStatus.STATUS_STOP) {
                stopRealPlay();
                setRealPlayStopUI();
            } else {
        ...
        } else if (view.getId() == R.id.realplay_previously_btn ||
                view.getId() == R.id.realplay_previously_btn2 ||
                view.getId() == R.id.realplay_full_previously_btn) {
            onCapturePicBtnClick();
        } else if (view.getId() == R.id.realplay_capture_rl) {
            onCaptureRlClick();
        } else if (view.getId() == R.id.realplay_video_btn ||
                view.getId() == R.id.realplay_video_start_btn ||
                view.getId() == R.id.realplay_video_btn2 ||
                view.getId() == R.id.realplay_video_start_btn2 ||
                view.getId() == R.id.realplay_full_video_btn ||
                view.getId() == R.id.realplay_full_video_start_btn) {
            onRecordBtnClick();
        } else if (view.getId() == R.id.realplay_talk_btn ||
                view.getId() == R.id.realplay_talk_btn2 ||
                view.getId() == R.id.realplay_full_talk_btn) {
            startVoiceTalk();
        } else if (view.getId() == R.id.realplay_quality_btn) {
            openQualityPopupWindow(mRealPlayQualityBtn);
        } else if (view.getId() == R.id.realplay_ptz_btn ||
                view.getId() == R.id.realplay_ptz_btn2) {
            openPtzPopupWindow(mRealPlayPageLy);
        } else if (view.getId() == R.id.realplay_full_ptz_btn) {
            setFullPtzStartUI(true);
        } else if (view.getId() == R.id.realplay_full_ptz_btn) {
            setFullPtzStopUI(true);
        } else if (view.getId() == R.id.realplay_sound_btn ||
                view.getId() == R.id.realplay_full_sound_btn) {
            onSoundBtnClick();
        } else if (view.getId() == R.id.realplay_full_talk_anim_btn) {
    ...
    private OnClickListener mOnPopWndClickListener = new OnClickListener() {
        @Override
        public void onClick(View v) {
            if(v.getId() == R.id.quality_hd_btn){
                setQualityMode(EZVideoLevel.VIDEO_LEVEL_HD);
            }else if(v.getId() == R.id.quality_balanced_btn){
                setQualityMode(EZVideoLevel.VIDEO_LEVEL_BALANCED);
            }else if(v.getId() == R.id.quality_flunet_btn){
                setQualityMode(EZVideoLevel.VIDEO_LEVEL_FLUNET);
            }else if(v.getId() == R.id.ptz_close_btn){
                closePtzPopupWindow();
            }else if(v.getId() == R.id.ptz_flip_btn){

            }else if(v.getId() == R.id.talkback_close_btn){
                closeTalkPopupWindow(true, false);
            }
        }
    };
...
//        mPtzPopupWindow.showAtLocation(parent, Gravity.BOTTOM, 0, 0);
        mPtzPopupWindow.showAsDropDown(mRealPlayPlayRl);
    ...
    private void startRealPlay() {
        ...
        if (mCameraInfo != null) {
            ...
            mEZPlayer = ezOpenSDK.createPlayerWithUrl(mRtspUrl);
    ...
    private void updateRealPlayFailUI(int errorCode) {
        ...
        switch (errorCode) {
            case ErrorCode.ERROR_TRANSF_ACCESSTOKEN_ERROR:
                ActivityUtils.goToLoginAgain(ezOpenSDK);
                return;
...
//                SecureValidate.secureValidateDialog(this, this);
    ...
    public boolean onTouch(View v, MotionEvent event) {
        if(v.getId() == R.id.realplay_full_operate_bar){
            return true;
        }
        return false;
    }
