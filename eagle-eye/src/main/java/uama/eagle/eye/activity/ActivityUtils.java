...
public class ActivityUtils {
     ...
     * @throws
     */
    public static void handleSessionException(EZOpenSDK ezOpenSDK) {
        goToLoginAgain(ezOpenSDK);
    }

    public static void goToLoginAgain(EZOpenSDK ezOpenSDK) {
        if (EZGlobalSDK.class.isInstance(ezOpenSDK)) {
