 ...
 */
package uama.hangzhou.image.album.ui;
...
import uama.hangzhou.image.album.internal.entity.Album;
...
public class MatisseActivity extends AppCompatActivity implements
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mSkip = (TextView) findViewById(R.id.selected_skip);
        mSkip.setVisibility(getIntent().getBooleanExtra(SHOW_SKIP, false) ? View.VISIBLE : View.GONE);
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.button_preview) {
            ...
            setResult(RESULT_OK, result);
            finish();
        } else if (v.getId() == R.id.selected_skip) {
            setResult(MatisseConstant.PhotoChooseSkip);//跳过
            finish();
        }
    }
