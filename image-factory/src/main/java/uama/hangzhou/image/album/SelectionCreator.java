...
import uama.hangzhou.image.album.engine.ImageEngine;
...
import uama.hangzhou.image.album.ui.MatisseActivity;
...
public final class SelectionCreator {
    ...
    public void forResult(int requestCode) {
        ...
        intent.putExtra(MatisseActivity.SHOW_SKIP, showSkip);
    ...
    //需要第一个设置
    public SelectionCreator setSkip(boolean bool) {
        showSkip = bool;
        return this;
    }
}
