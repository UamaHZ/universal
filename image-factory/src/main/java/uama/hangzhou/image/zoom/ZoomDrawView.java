package uama.hangzhou.image.zoom;
...
public class ZoomDrawView extends SimpleDraweeView implements IAttacher {

    private Attacher mAttacher;

    public ZoomDrawView(Context context, GenericDraweeHierarchy hierarchy) {
    ...
    public ZoomDrawView(Context context, AttributeSet attrs, int defStyle) {
